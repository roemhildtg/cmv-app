 ...
 *
 * CMV Recommendations
 * Use a separate build profile and build.sh file for each config file.  This will allow you to optimize the build for
 *   that specific application by only including the widgets and config files, as well as other dependencies that
 *   application uses.
 *   For instance, if you had created a 'countviewer' config file, create a 'countyviewer.profile.js' file and in the
 *   layers section, only include the widgets the 'countyviewer' application uses.  Also create a 'build-countyviewer.sh'
 *   file, setting the DISTDIR value to '$BASEDIR/dist/countyviewer'
 */
...
var profile = {
    ...
    layers: {
        ...
        // CMV specific notes
        // - if you have large modules conditionally loaded, then you might want to include as a second layer.
        //     Set 'boot' to false for these and make sure to include in index.html
        'dojo/dojo': {
            include: [
                'dojo/dojo',
                'cmv/config/viewer',
                ...
                //include all widgets used by this application
                ...
                //widget config files used by this application
                'cmv/config/basemaps',
                'cmv/config/bookmarks',
                'cmv/config/find',
                'cmv/config/identify',

                //esri widgets used by this application
                'esri/dijit/Attribution',
                'esri/dijit/HomeButton',
                'esri/dijit/Scalebar',
                'esri/dijit/OverviewMap',

                //dojox modules used by this application
                'dojox/gfx/svg',
                'dojo/selector/lite'
